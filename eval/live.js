...
const scenarios = [
  ...
  { id: "claim-switch-vs-secondary-mention", turns: [margaretDenied, "Does my February auto claim affect this healthcare claim?", "Actually, I meant my auto claim from February."], check: ({ session, results }) => results[1].session.resolvedCaseId === "CL-2048" && !results[1].events.some((event) => event.type === "case_retargeted") && session.resolvedCaseId === "CL-2102" && results.at(-1).events.some((event) => event.type === "case_retargeted") },
